...
### 5 Broadcaster'ов
- **AAA_PRICE** - Прайсы AAA (27 чатов, цикл 20 мин) - ОПТОВЫЙ
- **GUS_PRICE** - Прайсы GUS (27 чатов, цикл 20 мин) - РОЗНИЧНЫЙ
- **AAA_ADS** - Реклама AAA (16 чатов, цикл 1 час) - ОПТОВЫЙ
- **GUS_ADS** - Реклама GUS (16 чатов, цикл 1 час) - РОЗНИЧНЫЙ
- **GUS_B2C** - Розничные сообщения (66 чатов, цикл 2 часа) - РОЗНИЧНЫЙ ⭐ НОВЫЙ
...
│   ├── acc1_b2c.session   # GUS B2C (Яблочный Гусь) ⭐ НОВЫЙ
...
|-------------|---------|-----|------|------|----------|-----------|
| AAA_PRICE | acc2 | ОПТОВЫЙ | 27 | 20 мин | 90с | ~30 |
| GUS_PRICE | acc1 | РОЗНИЧНЫЙ | 27 | 20 мин | 90с | ~30 |
| AAA_ADS | acc2 | ОПТОВЫЙ | 16 | 1 час | 90с | ~20 |
| GUS_ADS | acc1 | РОЗНИЧНЫЙ | 16 | 1 час | 90с | ~20 |
| **GUS_B2C** | **acc1** | **РОЗНИЧНЫЙ** | **66** | **2 часа** | **120с** | **~65** ⭐ |

**Итого:** 5 broadcaster'ов, ~165 сообщений в 152 уникальных чата
